            ...
            <div class="rounded-lg border bg-card p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold">
                            {{ analytics.overview.total_playlists }}
                        </h3>
                    </div>
                    <div
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        >
                            ...
                            <span class="font-medium">{{
                                analytics.posts_by_type.article || 0
                            }}</span>
                        </div>
                        <div
                        ...
                        >
                            <div
                                ...
                                :style="{
                                    width: `${postTypePercentages.article}%`,
                                }"
                            ></div>
                        </div>
                    </div>
                    <div>
                        ...
                        >
                            ...
                            <span class="font-medium">{{
                                analytics.posts_by_type.carousel || 0
                            }}</span>
                        </div>
                        <div
                            class="h-2 w-full overflow-hidden rounded-full bg-secondary"
                        >
                            <div
                                ...
                                :style="{
                                    width: `${postTypePercentages.carousel}%`,
                                }"
                            ></div>
                        </div>
                    </div>
                    <div>
                        ...
                        >
                            ...
                            <span class="font-medium">{{
                                analytics.posts_by_type.video || 0
                            }}</span>
                        </div>
                        <div
                            class="h-2 w-full overflow-hidden rounded-full bg-secondary"
                        >
                            <div
                                ...
                                :style="{
                                    width: `${postTypePercentages.video}%`,
                                }"
                            ></div>
                        </div>
                    </div>
            ...
            <div class="rounded-lg border bg-card p-6">
                ...
                <div class="w-full space-y-3">
                    <div
                        ...
                        :key="post.id"
                        class="flex flex-1 flex-col justify-between gap-2 rounded-md border p-3 md:flex-row md:items-center"
                    >
